...
const APIGovernadorMS = () => {

    const BASEURL = "https://resultados.tse.jus.br/oficial/ele2022/546/dados-simplificados/ms/ms-c0003-e000546-r.json"
    ...
    const getUserGovernadorMS = async () => {
        ...
        <div>
            <div className="grupo-card">
                {cand.map((item, index) => (
                    ...
                    src={`https://resultados.tse.jus.br/oficial/ele2022/546/fotos/ms/${item.sqcand}.jpeg`}
                    alt="te"
                  />
                                    {item.pvap + "%"}
...
export default APIGovernadorMS