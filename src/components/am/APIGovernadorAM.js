...
const APIGovernadorAM = () => {

    const BASEURLGOVERNADORAM = "https://resultados-sim.tse.jus.br/teste/ele2022/9238/dados-simplificados/am/am-c0003-e009238-r.json"
    ...
    const getUserGovernadorAM = async () => {
        ...
        <div>
            <div className="grupo-card">
                {cand.map((item, index) => (
                    ...
                    src={`https://resultados-sim.tse.jus.br/teste/ele2022/9238/fotos/am/${item.sqcand}.jpeg`}
                    alt="te"
                  />
                                    {item.pvap + "%"}
...
export default APIGovernadorAM