...
const APIGovernadorAP = () => {
    ...
    const BASEURLGOVERNADORAP = "https://resultados.tse.jus.br/oficial/ele2022/546/dados-simplificados/ap/ap-c0003-e000546-r.json"
    ...
    const getUserGovernadorAP = async () => {
