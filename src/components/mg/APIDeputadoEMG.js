...
const APIDeputadoEMG = () => {
    ...
    const BASEURLDeputadoEMG = "https://resultados.tse.jus.br/oficial/ele2022/546/dados-simplificados/mg/mg-c0007-e000546-r.json"
    ...
    const getUserDeputadoEMG = async () => {
