...
const APIDeputadoFMG = () => {

    const BASEURLDeputadoFMG = "https://resultados-sim.tse.jus.br/teste/ele2022/9238/dados-simplificados/mg/mg-c0006-e009238-r.json"
    ...
    const getUserDeputadoFMG = async () => {
