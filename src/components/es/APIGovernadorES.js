...
const APIGovernadorES = () => {

    const BASEURL = "https://resultados.tse.jus.br/oficial/ele2022/546/dados-simplificados/es/es-c0003-e000546-r.json"
    ...
    const getUserGovernadorES = async () => {
        ...
        <div>
            <div className="grupo-card">
                {cand.map((item, index) => (
                    ...
                    src={`https://resultados.tse.jus.br/oficial/ele2022/546/fotos/es/${item.sqcand}.jpeg`}
                    alt="te"
                  />
                                    {item.pvap + "%"}
...
export default APIGovernadorES