...
const APIDeputadoFCE = () => {
    ...
    const BASEURLDeputadoFCE = "https://resultados-sim.tse.jus.br/teste/ele2022/9238/dados-simplificados/ce/ce-c0006-e009238-r.json"
    ...
    const getUserDeputadoFCE = async () => {
