...
const APIGovernadorCE = () => {
    ...
    const BASEURLGOVERNADORCE = "https://resultados-sim.tse.jus.br/teste/ele2022/9238/dados-simplificados/ce/ce-c0003-e009238-r.json"
    ...
    const getUserGovernadorCE = async () => {
...
export default APIGovernadorCE