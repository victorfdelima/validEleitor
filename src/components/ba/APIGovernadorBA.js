...
const APIGovernadorBA = () => {

    const BASEURL = "https://resultados.tse.jus.br/oficial/ele2022/546/dados-simplificados/ba/ba-c0003-e000546-r.json"
    ...
    const getUserGovernadorBA = async () => {
        ...
        <div>
            <div className="grupo-card">
                {cand.map((item, index) => (
                    ...
                    src={`https://resultados.tse.jus.br/oficial/ele2022/546/fotos/ba/${item.sqcand}.jpeg`}
                    alt="te"
                  />
                                    {item.pvap + "%"}
...
export default APIGovernadorBA