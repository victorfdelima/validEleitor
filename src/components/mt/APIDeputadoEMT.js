...
const APIDeputadoEMT = () => {
    ...
    const BASEURL = "https://resultados.tse.jus.br/oficial/ele2022/546/dados-simplificados/mt/mt-c0007-e000546-r.json"
    ...
    return (
            ...
            <div className="grupo-card">
                {filteredCands.map((item, index) => (
                    ...
                    src={`https://resultados.tse.jus.br/oficial/ele2022/546/fotos/mt/${item.sqcand}.jpeg`}
                    alt="te"
                  />
                                    {item.pvap + "%"}
                                        <br />
