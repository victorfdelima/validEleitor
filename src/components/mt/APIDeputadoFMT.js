...
const APIDeputadoFMT = () => {

    const BASEURLDeputadoFMT = "https://resultados-sim.tse.jus.br/teste/ele2022/9238/dados-simplificados/mt/mt-c0006-e009238-r.json"
    ...
    const getUserDeputadoFMT = async () => {
