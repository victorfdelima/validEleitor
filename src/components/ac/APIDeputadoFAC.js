...
const APIDeputadoFAC = () => {
    ...
    const BASEURLDeputadoFAC = "https://resultados-sim.tse.jus.br/teste/ele2022/9238/dados-simplificados/ac/ac-c0006-e009238-r.json"
    ...
    const getUserDeputadoFAC = async () => {
