...
const APISenador = () => {
    ...
    const BASEURLSENADOR = "https://resultados-sim.tse.jus.br/teste/ele2022/9238/dados-simplificados/rn/rn-c0005-e009238-r.json"
        ...
        <div>
            <div className="grupo-card">
                {cand.map((item, index) => (
                    ...
                    src={`https://resultados-sim.tse.jus.br/teste/ele2022/9238/fotos/rn/${item.sqcand}.jpeg`}
                    alt="te"
                  />
                                    {item.pvap + "%"}
                                        <br />
