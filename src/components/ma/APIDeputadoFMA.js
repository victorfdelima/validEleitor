...
const APIDeputadoFMA = () => {
    ...
    const BASEURL = "https://resultados.tse.jus.br/oficial/ele2022/546/dados-simplificados/ma/ma-c0006-e000546-r.json"
    ...
    return (
            ...
            <div className="grupo-card">
                {filteredCands.map((item, index) => (
                    ...
                    src={`https://resultados.tse.jus.br/oficial/ele2022/546/fotos/ma/${item.sqcand}.jpeg`}
                    alt="te"
                  />
                                    {item.pvap + "%"}
                                        <br />
