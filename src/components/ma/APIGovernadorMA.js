...
const APIGovernadorMA = () => {
    ...
    const BASEURLGOVERNADORMA = "https://resultados.tse.jus.br/oficial/ele2022/546/dados-simplificados/ma/ma-c0003-e000546-r.json"
        ...
        <div>
            <div className="grupo-card">
                {cand.map((item, index) => (
                    ...
                    src={`546/fotos/ma/${item.sqcand}.jpeg`}
                    alt="te"
                  />
                                    {item.pvap + "%"}
