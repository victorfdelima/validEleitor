...
const APISenador = () => {
    ...
    const BASEURL = "https://resultados.tse.jus.br/oficial/ele2022/546/dados-simplificados/se/se-c0005-e000546-r.json"
        ...
        <div>
            <div className="grupo-card">
                {cand.map((item, index) => (
                    ...
                    src={`https://resultados.tse.jus.br/oficial/ele2022/546/fotos/se/${item.sqcand}.jpeg`}
                    alt="te"
                  />
                                    {item.pvap + "%"}
                                        <br />
