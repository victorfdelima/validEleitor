...
const APIDeputadoFDF = () => {
    ...
    const BASEURLDeputadoFDF = "https://resultados-sim.tse.jus.br/teste/ele2022/9238/dados-simplificados/df/df-c0006-e009238-r.json"
    ...
    const getUserDeputadoFDF = async () => {
