...
const APIGovernadorDF = () => {

    const BASEURLGOVERNADORDF = "https://resultados-sim.tse.jus.br/teste/ele2022/9238/dados-simplificados/df/df-c0003-e009238-r.json"
    ...
    const getUserGovernadorDF = async () => {
...
export default APIGovernadorDF