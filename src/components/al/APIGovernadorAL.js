...
const APIGovernadorAL = () => {
    ...
    const BASEURLGOVERNADORAL = "https://resultados-sim.tse.jus.br/teste/ele2022/9238/dados-simplificados/al/al-c0003-e009238-r.json"
    ...
    const getUserGovernadorAL = async () => {
        ...
        <div>
            <div className="grupo-card">
                {cand.map((item, index) => (
                    ...
                    src={`https://resultados-sim.tse.jus.br/teste/ele2022/9238/fotos/al/${item.sqcand}.jpeg`}
                    alt="te"
                  />
                                    {item.pvap + "%"}
...
export default APIGovernadorAL